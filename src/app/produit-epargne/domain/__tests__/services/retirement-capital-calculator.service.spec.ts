...
import { RetirementCapitalCalculatorService } from '../../services/retirement-capital-calculator.service';
...
it('should estimate retirement capital with 4% annual growth', () => {
  ...
  const result = RetirementCapitalCalculatorService.calculate(sim);
